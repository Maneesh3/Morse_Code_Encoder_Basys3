...
HD_PWD='C:/Users/klu/Desktop/morse_code_encoder/morse_code_encoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_encoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source morse_encoder.tcl -notrace
